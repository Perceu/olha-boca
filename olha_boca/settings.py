"""
Django settings for olha_boca project.
...
WSGI_APPLICATION = 'olha_boca.wsgi.application'
...
DATABASES = {
    'default': config('DATABASE_URL', defaults=default_db_url, cast=parse_database)
}
